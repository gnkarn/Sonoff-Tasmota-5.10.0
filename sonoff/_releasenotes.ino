 ...
 * Version modificada por GNK para adicionar control IR de aire acondicionado
 * Carrier , para control de temperatura por medio de mqtt con home assistant .
 * https://github.com/markszabo/IRremoteESP8266/issues/385  enero 20118
 */
