...
// -- Project -------------------------------------
#define PROJECT                "hvac_1"          // PROJECT is used as the default topic delimiter and OTA file name
                                                 //   As an IDE restriction it needs to be the same as the main .ino file

#define CFG_HOLDER             0x20161255        // [Reset 1] Change this value to load following default configuration parameters
#define SAVE_DATA              1                 // [SaveData] Save changed parameters to Flash (0 = disable, 1 - 3600 seconds)
#define SAVE_STATE             1                 // [SetOption0] Save changed power state to Flash (0 = disable, 1 = enable)

// -- Wifi ----------------------------------------
#define WIFI_IP_ADDRESS        "192.168.0.15"         // [IpAddress1] Set to 0.0.0.0 for using DHCP or IP address
...
#define USE_WEBSERVER                            // Enable web server and wifi manager (+66k code, +8k mem) - Disable by //
  ...
  #define FRIENDLY_NAME        "sonoff-hvac_1"          // [FriendlyName] Friendlyname up to 32 characters used by webpages and Alexa
